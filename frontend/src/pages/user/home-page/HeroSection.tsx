            ...
            <div className="max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center px-6 space-x-12">
                ...
                <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
                    ...
                    <p className="text-lg text-gray-600 text-justify">
                        Khám phá hàng ngàn cơ hội việc làm được cập nhật liên
                        tục, bộ lọc thông minh, hỗ trợ 24/7 để bạn không bỏ lỡ
                        bất kỳ vị trí mơ ước nào.
                    </p>
                    <button className="inline-flex items-center px-6 py-3 bg-green-500 text-white font-medium rounded-md hover:bg-green-600 transition">

...
const menuItems: MenuItem[] = [
    {
        ...
        icon: Building2,
        permission: "GET /company/me/company",
    },
    {
        title: "Đội ngũ tuyển dụng",
        url: "/recruiter/members",
        icon: UserRound,
        permission: "GET /company/me/recruiters",
    },
    {
        title: "Công việc",
        url: "/recruiter/jobs",
...
export function RecruiterSidebar() {
    ...
    return (
        <Sidebar className="w-64 shrink-0 border-r border-purple-100 bg-white">
            ...
            <SidebarFooter className="border-t bg-white border-purple-100 px-3 py-4">
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton
                            asChild
